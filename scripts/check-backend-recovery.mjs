...
assert.match(hook, /readinessTimeoutMs = 30_000/);
assert.match(hook, /unavailableAfterFailures = 2/);
assert.match(hook, /failedChecks\.current >= unavailableAfterFailures/);
assert.match(hook, /failedChecks\.current = 0/);
assert.match(hook, /probeInProgress\.current/);
