...
const rawWorkspaceLayoutPresets: WorkspaceLayoutPreset[] = [
  {
    ...
    layerPreset: {
      emphasisLayerIds: ["opportunity-extrusions", "scenario-envelope"],
      visibleLayerIds: [
        "county-boundary",
        "parcel-intelligence",
  ...
  },
  {
    ...
    layerPreset: {
      emphasisLayerIds: ["parcel-intelligence", "opportunity-extrusions"],
      visibleLayerIds: [
        "county-boundary",
        "parcel-intelligence",
        "opportunity-extrusions",
  ...
  },
  {
    ...
    layerPreset: {
      emphasisLayerIds: ["infrastructure-readiness"],
      visibleLayerIds: [
        "county-boundary",
        "parcel-intelligence",
        "infrastructure-readiness",
  ...
  },
  {
    ...
    layerPreset: {
      emphasisLayerIds: ["development-pressure", "opportunity-extrusions"],
      visibleLayerIds: [
        "county-boundary",
        "parcel-intelligence",
        "opportunity-extrusions",
  ...
  },
  {
    ...
    layerPreset: {
      emphasisLayerIds: ["scenario-envelope", "permit-activity"],
      visibleLayerIds: [
        "county-boundary",
        "parcel-intelligence",
        "development-pressure",
