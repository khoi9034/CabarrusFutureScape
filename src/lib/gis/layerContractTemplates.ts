...
export const parcelLayerContractTemplate: ArcGISLayerContract = {
  ...
  popupTitleTemplate: "{parcelId}",
    rendererExpectations: "Simple parcel outline with selected-state override supplied by Cabarrus Insights.",
...
export const eventLayerContractTemplate: ArcGISLayerContract = {
  ...
  popupTitleTemplate: "{eventType}",
    rendererExpectations: "Severity-coded marker renderer with unread/read state controlled by Cabarrus Insights.",
