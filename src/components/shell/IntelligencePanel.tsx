...
import { ParcelSummaryPanel } from "@/components/parcels/ParcelSummaryPanel";
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <ScoreCard
            ...
            label="Readiness"
            score={selectedParcel.infrastructureReadiness}
          />
          <ScoreCard
            accent="#ffb454"
            caption="Growth pressure from nearby permits and demand."
            label="Pressure"
            score={selectedParcel.developmentPressure}
          />
        </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
            <div className="rounded-md border border-white/10 bg-white/[0.035] p-3">
              ...
              <p className="mt-1 text-lg font-semibold text-white">
                {formatCurrency(selectedParcel.taxOpportunity * 125000)}
              </p>
            </div>
            <div className="rounded-md border border-white/10 bg-white/[0.035] p-3">
              <p className="text-[11px] uppercase text-slate-500">
            ...
            {rankedParcels.map((parcel) => {
              ...
              return (
                <button
                  ...
                  key={parcel.parcelId}
                  onClick={() => selectParcel(parcel.parcelId)}
                  type="button"
                >
